...
TABLAS_OSTEOPOROSIS = [
    "sgss_ctdaa10_anio_osteoporosis",
    # "sgss_mtdae10_anio_osteoporosis",
    # "sgss_htdah10_anio_osteoporosis",
    # "sgss_qtiod10_anio_osteoporosis",
]
...
PREFIJOS = {
    "sgss_ctdaa10_anio_osteoporosis": "atenamb",
    # "sgss_mtdae10_anio_osteoporosis": "ateeme",
    # "sgss_htdah10_anio_osteoporosis": "atenhos",
    # "sgss_qtiod10_anio_osteoporosis": "infope"
}
...
def procesar_datos(fecha_inicio, fecha_fin):
    ...
    for i in range(len(TABLAS_OSTEOPOROSIS)):
        tabla_a = TABLAS_OSTEOPOROSIS[i]
        ...
        for anio in range(int(fecha_inicio[:4]), int(fecha_fin[:4]) + 1):
            for mes in range(1, 13):
                ...
                try:
                    area = "'CEXT'" if tabla_a == "sgss_ctdaa10_anio_osteoporosis" else \
                            "'EMER'" if tabla_a == "sgss_mtdae10_anio_osteoporosis" else \
                            "'HOSP'" if tabla_a == "sgss_htdah10_anio_osteoporosis" else \
                            "'CQX'" if tabla_a == "sgss_qtiod10_anio_osteoporosis" else ''
                    cod_secuencia = "''" if tabla_a == "sgss_ctdaa10_anio_osteoporosis" else \
                            f"{prefijo}secnum"
                    cod_actividad = "cod_actividad" if tabla_a == "sgss_ctdaa10_anio_osteoporosis" else \
                            "''" if tabla_a == "sgss_mtdae10_anio_osteoporosis" else \
                            "cod_actividad" if tabla_a == "sgss_htdah10_anio_osteoporosis" else \
                            "''" if tabla_a == "sgss_qtiod10_anio_osteoporosis" else ''
                    cod_subactividad = "cod_subactividad" if tabla_a == "sgss_ctdaa10_anio_osteoporosis" else \
                            "''" if tabla_a == "sgss_mtdae10_anio_osteoporosis" else \
                            "''" if tabla_a == "sgss_htdah10_anio_osteoporosis" else \
                            "''" if tabla_a == "sgss_qtiod10_anio_osteoporosis" else ''
                    cod_cartera = "cod_cartera" if tabla_a == "sgss_ctdaa10_anio_osteoporosis" else \
                            "''" if tabla_a == "sgss_mtdae10_anio_osteoporosis" else \
                            "''" if tabla_a == "sgss_htdah10_anio_osteoporosis" else \
                            "''" if tabla_a == "sgss_qtiod10_anio_osteoporosis" else ''
                    cod_cpms = "cod_cpms" if tabla_a == "sgss_ctdaa10_anio_osteoporosis" else \
                            "''" if tabla_a == "sgss_mtdae10_anio_osteoporosis" else \
                            "''" if tabla_a == "sgss_htdah10_anio_osteoporosis" else \
                            "cod_cpms" if tabla_a == "sgss_qtiod10_anio_osteoporosis" else ''
                    cod_tipdoc_medico = "cod_tipdoc_medico" if tabla_a == "sgss_ctdaa10_anio_osteoporosis" else \
                            "''" if tabla_a == "sgss_mtdae10_anio_osteoporosis" else \
                            "cod_tipdoc_medico" if tabla_a == "sgss_htdah10_anio_osteoporosis" else \
                            "cod_tipdoc_medico" if tabla_a == "sgss_qtiod10_anio_osteoporosis" else ''
                    dni_medico = "dni_medico" if tabla_a == "sgss_ctdaa10_anio_osteoporosis" else \
                            "''" if tabla_a == "sgss_mtdae10_anio_osteoporosis" else \
                            "dni_medico" if tabla_a == "sgss_htdah10_anio_osteoporosis" else \
                            "dni_medico" if tabla_a == "sgss_qtiod10_anio_osteoporosis" else ''
                    query = f"""
