...
TABLAS_VPH = [
    ...
    # "sgss_mtdae10_anio_vph",
    # "sgss_htdah10_anio_vph",
    # "sgss_qtiod10_anio_vph",
]
...
TABLAS_TMP = [
    "tmp_vph_actmed_ctdaa10",
    # "tmp_vph_actmed_mtdae10",
    # "tmp_vph_actmed_htdah10",
    # "tmp_vph_actmed_qtiod10",
]

# Mapear prefijos para cada tabla
PREFIJOS = {
    "sgss_ctdaa10_anio_vph": "atenamb",
    # "sgss_mtdae10_anio_vph": "ateeme",
    # "sgss_htdah10_anio_vph": "atenhos",
    # "sgss_qtiod10_anio_vph": "infope"
}
...
def procesar_datos(fecha_inicio, fecha_fin):
    ...
    for i in range(len(TABLAS_VPH)):
        tabla_a = TABLAS_VPH[i]
        ...
        for anio in range(int(fecha_inicio[:4]), int(fecha_fin[:4]) + 1):
            for mes in range(1, 13):
                ...
                try:
                    area = "'CEXT'" if tabla_a == "sgss_ctdaa10_anio_vph" else \
                            "'EMER'" if tabla_a == "sgss_mtdae10_anio_vph" else \
                            "'HOSP'" if tabla_a == "sgss_htdah10_anio_vph" else \
                            "'CQX'" if tabla_a == "sgss_qtiod10_anio_vph" else ''
                    cod_secuencia = "''" if tabla_a == "sgss_ctdaa10_anio_vph" else \
                            f"{prefijo}secnum"
                    cod_actividad = "cod_actividad" if tabla_a == "sgss_ctdaa10_anio_vph" else \
                            "''" if tabla_a == "sgss_mtdae10_anio_vph" else \
                            "cod_actividad" if tabla_a == "sgss_htdah10_anio_vph" else \
                            "''" if tabla_a == "sgss_qtiod10_anio_vph" else ''
                    cod_subactividad = "cod_subactividad" if tabla_a == "sgss_ctdaa10_anio_vph" else \
                            "''" if tabla_a == "sgss_mtdae10_anio_vph" else \
                            "''" if tabla_a == "sgss_htdah10_anio_vph" else \
                            "''" if tabla_a == "sgss_qtiod10_anio_vph" else ''
                    cod_cartera = "cod_cartera" if tabla_a == "sgss_ctdaa10_anio_vph" else \
                            "''" if tabla_a == "sgss_mtdae10_anio_vph" else \
                            "''" if tabla_a == "sgss_htdah10_anio_vph" else \
                            "''" if tabla_a == "sgss_qtiod10_anio_vph" else ''
                    cod_cpms = "cod_cpms" if tabla_a == "sgss_ctdaa10_anio_vph" else \
                            "''" if tabla_a == "sgss_mtdae10_anio_vph" else \
                            "''" if tabla_a == "sgss_htdah10_anio_vph" else \
                            "cod_cpms" if tabla_a == "sgss_qtiod10_anio_vph" else ''
                    cod_tipdoc_medico = "cod_tipdoc_medico" if tabla_a == "sgss_ctdaa10_anio_vph" else \
                            "''" if tabla_a == "sgss_mtdae10_anio_vph" else \
                            "cod_tipdoc_medico" if tabla_a == "sgss_htdah10_anio_vph" else \
                            "cod_tipdoc_medico" if tabla_a == "sgss_qtiod10_anio_vph" else ''
                    dni_medico = "dni_medico" if tabla_a == "sgss_ctdaa10_anio_vph" else \
                            "''" if tabla_a == "sgss_mtdae10_anio_vph" else \
                            "dni_medico" if tabla_a == "sgss_htdah10_anio_vph" else \
                            "dni_medico" if tabla_a == "sgss_qtiod10_anio_vph" else ''
                    query = f"""
