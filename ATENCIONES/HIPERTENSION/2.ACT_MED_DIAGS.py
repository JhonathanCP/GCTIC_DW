...
PREFIJOS = {
    "sgss_ctdaa10_anio_hipertension": "atenamb",
    "sgss_mtdae10_anio_hipertension": "ateeme",
    "sgss_htdah10_anio_hipertension": "atenhos",
}
...
def procesar_datos(fecha_inicio, fecha_fin):
    ...
    for i in range(len(TABLAS_HIPERTENSION)):
        tabla_a = TABLAS_HIPERTENSION[i]
        ...
        for anio in range(int(fecha_inicio[:4]), int(fecha_fin[:4]) + 1):
            for mes in range(1, 13):
                ...
                try:
                    area = "'CEXT'" if tabla_a == "sgss_ctdaa10_anio_hipertension" else \
                            "'EMER'" if tabla_a == "sgss_mtdae10_anio_hipertension" else \
                            "'HOSP'" if tabla_a == "sgss_htdah10_anio_hipertension" else ''
                    cod_secuencia = "''" if tabla_a == "sgss_ctdaa10_anio_hipertension" else \
                            f"{prefijo}secnum"
                    cod_actividad = "cod_actividad" if tabla_a == "sgss_ctdaa10_anio_hipertension" else \
                            "''" if tabla_a == "sgss_mtdae10_anio_hipertension" else \
                            "cod_actividad" if tabla_a == "sgss_htdah10_anio_hipertension" else ''
                    cod_subactividad = "cod_subactividad" if tabla_a == "sgss_ctdaa10_anio_hipertension" else \
                            "''" if tabla_a == "sgss_mtdae10_anio_hipertension" else \
                            "''" if tabla_a == "sgss_htdah10_anio_hipertension" else ''
                    cod_cartera = "cod_cartera" if tabla_a == "sgss_ctdaa10_anio_hipertension" else \
                            "''" if tabla_a == "sgss_mtdae10_anio_hipertension" else \
                            "''" if tabla_a == "sgss_htdah10_anio_hipertension" else ''
                    cod_cpms = "cod_cpms" if tabla_a == "sgss_ctdaa10_anio_hipertension" else \
                            "''" if tabla_a == "sgss_mtdae10_anio_hipertension" else \
                            "''" if tabla_a == "sgss_htdah10_anio_hipertension" else ''
                    cod_tipdoc_medico = "cod_tipdoc_medico" if tabla_a == "sgss_ctdaa10_anio_hipertension" else \
                            "''" if tabla_a == "sgss_mtdae10_anio_hipertension" else \
                            "cod_tipdoc_medico" if tabla_a == "sgss_htdah10_anio_hipertension" else ''
                    dni_medico = "dni_medico" if tabla_a == "sgss_ctdaa10_anio_hipertension" else \
                            "''" if tabla_a == "sgss_mtdae10_anio_hipertension" else \
                            "dni_medico" if tabla_a == "sgss_htdah10_anio_hipertension" else ''
                    query = f"""
