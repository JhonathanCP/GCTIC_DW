...
TABLAS_TMP = [
    ...
    "tmp_obesidad_actmed_mtdae10",
    "tmp_obesidad_actmed_htdah10",
]

# Mapear prefijos para cada tabla
PREFIJOS = {
    "sgss_ctdaa10_anio_obesidad": "atenamb",
    "sgss_mtdae10_anio_obesidad": "ateeme",
    "sgss_htdah10_anio_obesidad": "atenhos"
}
