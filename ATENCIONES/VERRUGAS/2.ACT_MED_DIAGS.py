...
TABLAS_VERRUGAS = [
    "sgss_ctdaa10_anio_verrugas",
    # "sgss_mtdae10_anio_verrugas",
    # "sgss_htdah10_anio_verrugas",
    # "sgss_qtiod10_anio_verrugas",
]
...
TABLAS_TMP = [
    "tmp_verrugas_actmed_ctdaa10",
    # "tmp_verrugas_actmed_mtdae10",
    # "tmp_verrugas_actmed_htdah10",
    # "tmp_verrugas_actmed_qtiod10",
]

# Mapear prefijos para cada tabla
PREFIJOS = {
    "sgss_ctdaa10_anio_verrugas": "atenamb",
    # "sgss_mtdae10_anio_verrugas": "ateeme",
    # "sgss_htdah10_anio_verrugas": "atenhos",
    # "sgss_qtiod10_anio_verrugas": "infope"
}
...
def procesar_datos(fecha_inicio, fecha_fin):
    ...
    for i in range(len(TABLAS_VERRUGAS)):
        tabla_a = TABLAS_VERRUGAS[i]
        ...
        for anio in range(int(fecha_inicio[:4]), int(fecha_fin[:4]) + 1):
            for mes in range(1, 13):
                ...
                try:
                    area = "'CEXT'" if tabla_a == "sgss_ctdaa10_anio_verrugas" else \
                            "'EMER'" if tabla_a == "sgss_mtdae10_anio_verrugas" else \
                            "'HOSP'" if tabla_a == "sgss_htdah10_anio_verrugas" else \
                            "'CQX'" if tabla_a == "sgss_qtiod10_anio_verrugas" else ''
                    cod_secuencia = "''" if tabla_a == "sgss_ctdaa10_anio_verrugas" else \
                            f"{prefijo}secnum"
                    cod_actividad = "cod_actividad" if tabla_a == "sgss_ctdaa10_anio_verrugas" else \
                            "''" if tabla_a == "sgss_mtdae10_anio_verrugas" else \
                            "cod_actividad" if tabla_a == "sgss_htdah10_anio_verrugas" else \
                            "''" if tabla_a == "sgss_qtiod10_anio_verrugas" else ''
                    cod_subactividad = "cod_subactividad" if tabla_a == "sgss_ctdaa10_anio_verrugas" else \
                            "''" if tabla_a == "sgss_mtdae10_anio_verrugas" else \
                            "''" if tabla_a == "sgss_htdah10_anio_verrugas" else \
                            "''" if tabla_a == "sgss_qtiod10_anio_verrugas" else ''
                    cod_cartera = "cod_cartera" if tabla_a == "sgss_ctdaa10_anio_verrugas" else \
                            "''" if tabla_a == "sgss_mtdae10_anio_verrugas" else \
                            "''" if tabla_a == "sgss_htdah10_anio_verrugas" else \
                            "''" if tabla_a == "sgss_qtiod10_anio_verrugas" else ''
                    cod_cpms = "cod_cpms" if tabla_a == "sgss_ctdaa10_anio_verrugas" else \
                            "''" if tabla_a == "sgss_mtdae10_anio_verrugas" else \
                            "''" if tabla_a == "sgss_htdah10_anio_verrugas" else \
                            "cod_cpms" if tabla_a == "sgss_qtiod10_anio_verrugas" else ''
                    cod_tipdoc_medico = "cod_tipdoc_medico" if tabla_a == "sgss_ctdaa10_anio_verrugas" else \
                            "''" if tabla_a == "sgss_mtdae10_anio_verrugas" else \
                            "cod_tipdoc_medico" if tabla_a == "sgss_htdah10_anio_verrugas" else \
                            "cod_tipdoc_medico" if tabla_a == "sgss_qtiod10_anio_verrugas" else ''
                    dni_medico = "dni_medico" if tabla_a == "sgss_ctdaa10_anio_verrugas" else \
                            "''" if tabla_a == "sgss_mtdae10_anio_verrugas" else \
                            "dni_medico" if tabla_a == "sgss_htdah10_anio_verrugas" else \
                            "dni_medico" if tabla_a == "sgss_qtiod10_anio_verrugas" else ''
                    query = f"""
