...
######################FUNCIONES DE LOG###########################
	...
	ALTER COLUMN infopeanesecue TYPE numeric(2,0) USING infopeanesecue::numeric(2,0),
	ALTER COLUMN infopeaneanecod TYPE character(3) USING infopeaneanecod::character(3),
	ALTER COLUMN infopeaneestregcod TYPE character(1) USING infopeaneestregcod::character(1),
	...
	merge=pd.merge(base1,cqxaneste,how='left',on='cod_ane')
	base1=pd.merge(base1,cqxaneste,how='left',on='cod_ane')
	base1.shape
